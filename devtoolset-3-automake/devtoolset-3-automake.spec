%{?scl:%scl_package automake16}
%{!?scl:%global pkg_name %{name}}

%define api_version 1.6

Summary:    A GNU tool for automatically creating Makefiles
Name:       devtoolset-3-automake16
...
Obsoletes:  %{?scl_prefix}automake = %{api_version}.3
# Required for tests:
Buildrequires:  %{?scl_prefix}autoconf >= 2.52
Buildrequires:  %{?scl_prefix}bison %{?scl_prefix}flex %{?scl_prefix}texinfo
